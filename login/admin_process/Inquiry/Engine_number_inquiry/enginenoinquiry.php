                            ...
                            <div class="col-md-7">
                                ...
                                <form action="" method="GET">
                                    <div class="input-group mb-3">
                                        <input type="text" name="search" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" class="form-control" placeholder="Enter Vehicle Engine Number To Search">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM vehicle WHERE CONCAT(engineno) LIKE '%$filtervalues%' ";
                                        ...
                                        else
                                        {
                                            ?>
                                                ...
                                                <div class="alert alert-danger" role="alert">
                                                     Engine No Mismatch With The System!
                                                </div>
                                            <?php
                                        }
                                    }
